...
function Logo({ align = "center" }) {
  ...
  return (
    ...
    >
      <div className="inline-flex items-center justify-center rounded-2xl bg-gradient-to-tr from-sky-500 to-violet-500 p-2 shadow-sm">
        <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white/90 text-sm font-bold text-sky-600">
          TP
        </div>
      </div>
      <div>
        ...
        <div className="text-xs text-slate-500">Личные дела и задачи</div>
      </div>
    </div>
  );
}
